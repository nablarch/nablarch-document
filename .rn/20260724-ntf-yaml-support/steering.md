...
- モジュール側の進行: yaml `#51`（送付済み 2026-09-07 夜）→ converter `#57` → Example ウェブ #7 → integration `#26`（同指示書 §3〜§5）。

...
.. important:: 
  ...
  上記タグを使用して外部サイトへのリンクやボタンを作成した場合、新しいウィンドウでページを開けないケースがある。
  (例えば、IEの保護モードを有効にした場合に、この事象が発生する。)
  このため、外部サイトを新しいウィンドウで開くようなリンクやボタンは :ref:`tag-a_tag` やhtmlタグを用いて作成すること。

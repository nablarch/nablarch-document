...
+====================+======================+=============================+
|テストソースファイル|<PROJECT_ROOT>/test   |ExampleDbAccessTest.java     |
+--------------------+/jp/co/tis/example/db/+-----------------------------+
|Excelファイル       |                      |ExampleDbAccessTest.xlsx [#]_|
+--------------------+----------------------+-----------------------------+
...
.. [#]
 ...
 +----------------------------+----------------------+-----------------------------------+
 |${半角数字,2}-${半角数字,4} | 37-3425              |-以外が変換される。                |
 +----------------------------+----------------------+-----------------------------------+
...
.. important::
  ...
  この機能は、JUnit 4からJUnit 5への移行を段階的に進めるための補助として利用できる。

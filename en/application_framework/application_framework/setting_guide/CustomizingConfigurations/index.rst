...
\ :download:`Default configuration list <../../configuration/default-configuration-list.xlsx>`\ を確認の上、デフォルト値でPJ要件を満たせない箇所については、環境設定ファイル(configファイル)を修正する。
...
\ :download:`Default configuration list <../../configuration/default-configuration-list.xlsx>`\ でデフォルトコンフィグレーションで設定されている内容が確認できる。
...
\ :download:`Default configuration list <../../configuration/default-configuration-list.xlsx>`\ でデフォルトコンフィグレーションで、プレースホルダーが使われていない設定を確認できる。
...
コンポーネント設定ファイルや環境設定ファイル(configファイル)の設定変更の具体例は以下を参照のこと。

...
.. important::
  ...
  For this reason, testing framework such as `JUnit (external site) <https://junit.org/junit5/>`_  should be used for testing applications that use these platforms and libraries.

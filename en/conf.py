...
version = '6-NEXT-SNAPSHOT'
# The full version, including alpha/beta/rc tags.
release = '6-NEXT-SNAPSHOT'
...
javadoc_url_map = {
  ...
  'java' : ('https://docs.oracle.com/en/java/javase/17/docs/api/java.base/', 'javadoc'),
  'java.sql' : ('https://docs.oracle.com/en/java/javase/17/docs/api/java.sql/', 'javadoc'),
  'javax' : ('https://docs.oracle.com/en/java/javase/17/docs/api/java.base/', 'javadoc'),
  'javax.sql' : ('https://docs.oracle.com/en/java/javase/17/docs/api/java.sql/', 'javadoc')
}
